    ...
    <header className="border-b border-gray-800 bg-gray-950/80 backdrop-blur-xl sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl gradient-solana flex items-center justify-center font-bold text-lg">
            ⇄
          </div>
          <div>
            <h1 className="text-lg font-bold">SOL ⇄ DCC Bridge</h1>
            <p className="text-xs text-gray-400">Multi-Token Cross-Chain Gateway</p>
          </div>
        </div>
